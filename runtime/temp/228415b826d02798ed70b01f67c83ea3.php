<?php /*a:1:{s:65:"/www/wwwroot/103.29.3.172/application/index/view/user/forget.html";i:1585138974;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0052)http://qiang6-www.baomiche.com/#/Register?code=79053 --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title>找回密码</title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><style type="text/css" title="fading circle style">
        ...
        .form-buttom2{
            ...
            text-align: center;
                     ...
                     alt="" class="return"></div><div data-v-79134734="" class="Maintitle"><h3 data-v-79134734="">找回密码</h3></div><div data-v-79134734="" class="right_btn"><div data-v-79134734="" class="t1"><div data-v-79134734="" class="t2"><span data-v-79134734="">请点击右上角</span><span data-v-79134734="">在浏览器打开</span></div></div></div></div><div data-v-79134734="" class="box"><form action="" id="forgetpwd-form"><ul data-v-79134734=""><li data-v-79134734=""><input data-v-79134734="" type="text" name="tel" placeholder="请输入手机号"><span data-v-79134734="" class="eye fa get-code">发送验证码</span></li><li data-v-79134734=""><input data-v-79134734="" type="text" name="verify" placeholder="请输入短信验证码"></li><li data-v-79134734=""><input data-v-79134734="" placeholder="请输入密码" name="pwd" type="password"><img data-v-79134734=""
                             ...
                             alt="" class="eye"></li><li data-v-79134734=""><input data-v-79134734="" placeholder="请确认密码" name="pwd_re" type="password"><img data-v-79134734=""
                             src="data:image/png;base64,"
                             alt="" class="eye"></li></ul><div data-v-79134734=""><button data-v-79134734="" class="form-buttom">提交</button><span data-v-79134734="" class="a3 a4 form-buttom2"  onclick="window.location.href=`/index/user/login`">已有账号，去登录</span></div></form></div></div></div><script type="application/javascript">
    $(function(){
        var countdown = 60;
        var flag = true;
        var loading = null;
